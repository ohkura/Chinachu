	...
	drawMain: function() {
		...
		for (var i = 0, l = global.chinachu.recorded.length; i < l; i++) {
			...
			if (this.self.query.title &&
					program.title.match(this.self.query.title) === null &&
					program.fullTitle.match(this.self.query.title) === null &&
					program.subTitle.match(this.self.query.title) === null) continue;
